...
fn main() {
    ...
    writeln!(key_sequence_file, "// Generated by build.rs").unwrap();
    ...
    writeln!(key_sequence_file, "#[allow(non_camel_case_types)]").unwrap();
    writeln!(key_sequence_file, "#[allow(clippy::upper_case_acronyms)]").unwrap();
    writeln!(key_sequence_file, "#[allow(unused)]").unwrap();
